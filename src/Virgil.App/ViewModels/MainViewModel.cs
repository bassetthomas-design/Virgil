...
public class MainViewModel : INotifyPropertyChanged
{
    ...
    {
        Messages.Add("Virgil prêt. Monitoring + Maintenance.");
    ...
    {
        Messages.Add("Mode maintenance activé.");
        await DoWinget();
        await DoWU();
        await DoDef();
    ...
    {
        Messages.Add("Applications et jeux: mise à jour en cours.");
        var code = await _ops.RunWingetUpgradeAsync();
        Messages.Add(code==0 ? "Mises à jour apps/jeux OK." : $"Winget a retourné {code}.");
    }

    private async Task DoWU()
    {
        Messages.Add("Windows Update: scan, download, install.");
    ...
    {
        Messages.Add("Defender: signatures + scan rapide.");
