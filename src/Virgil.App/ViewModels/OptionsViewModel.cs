...
public class OptionsViewModel : INotifyPropertyChanged
{
    ...
    public async Task LoadAsync()
    {
        ...
        Thumbnails = o.Thumbnails; ExplorerCache = o.ExplorerCache; MruRecent = o.MruRecent; BrowserCookies = o.BrowserCookies; RestartExplorerAfterRebuild = o.RestartExplorerAfterRebuild;
    }
